export default function ContactHero() {
  return (
    <>
      ...
      <section
        className="relative overflow-hidden py-9 md:py-20"
        ...
        <div className="container relative z-10 max-w-7xl flex items-center justify-between gap-8">
          ...
          >
            <img
              ...
              alt="Amma Eye Care Hospital contact"
              width={200}
              height={200}
            ...
            {/* Floating card — top-left: "Connect With Us!" */}
            <div
            ...
            >
              <p className="text-sm font-bold leading-snug text-gray-800">
                <span style={{ color: "#185fa5" }}>Connect</span> With Us!
              </p>
            </div>
          </div>
        </div>
